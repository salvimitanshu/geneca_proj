export default {
  pages: {
    ...
    data: [
      ...
      {title: "Test1",        url: "/dashboard/ecommerce",                icon: "HomeIcon",           is_bookmarked: false},

      // APPS
      { title: "Demographs", url: "/dashboard/analytics",                          icon: "CheckSquareIcon",    is_bookmarked: true},
      { title: "Client History",                       url: "/apps/chat",                          icon: "MessageSquareIcon",  is_bookmarked: true},
      { title: "Complaints",                      url: "/apps/email",                         icon: "MailIcon",           is_bookmarked: true},
      { title: "PAtient History",                   url: "/apps/calendar/vue-simple-calendar",  icon: "CalendarIcon",       is_bookmarked: true},
      {title: "Test",            url: "/apps/eCommerce/shop",                icon: "ShoppingCartIcon",   is_bookmarked: true},
      {title: "Test",     url: "/apps/eCommerce/item",                icon: "SmartphoneIcon",     is_bookmarked: false},
     ...
     // {title: "E-Commerce Checkout",        url: "/apps/eCommerce/checkout",            icon: "CreditCardIcon",     is_bookmarked: false},
      ...
      // UI ELEMENTS
      { title: "Test1",     url: "/ui-elements/data-list/list-view",    icon: "ListIcon",           is_bookmarked: false},
